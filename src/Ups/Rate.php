...
//        print_r($request);
//        die();
//        print_r($this->request($this->createAccess(), $request, $this->compileEndpointUrl(self::ENDPOINT)));
//        die();
    ...
    private function createRequest(RateRequest $rateRequest)
    {
        ...
        $shipmentRateOptions = $shipment->getRateInformation();
        if (isset($shipmentRateOptions)) {
            $shipmentNode->appendChild($shipmentRateOptions->toNode($document));
        }
